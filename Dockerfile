...
CMD ["sh" , "-c", "java -jar -Dserver.port=$PORT -Djwt.secretkey=$JWT_SECRETKEY -Dspring.data.mongodb.uri='mongodb+srv://testUser:$MONGODB_USER_PASSWORD@cluster0.zatly.mongodb.net/Cluster0?retryWrites=true&w=majority' app.jar"]